...
import { InputComponentOptions } from './input.d'
  ...
  return (
    <div class="relative">
      ...
      <input
        ...
        id={id}
        class="peer p-4 block w-full bg-gray-100 border-transparent rounded-lg text-sm placeholder:text-transparent focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-700 dark:border-transparent dark:text-white dark:focus:ring-neutral-600
    focus:pt-6
    focus:pb-2
